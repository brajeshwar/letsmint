...
<div id="content-wrap">
	<div id="left">
		<div id="left-in">
			<div id="feed"><br /><a href="<?php bloginfo('rss2_url'); ?>"><img src="<?php echo get_bloginfo(template_directory); ?>/i/ico_feed_shadow.gif" width="72" height="109" alt="Subscribe to RSS Feeds" border="0" /></a>
			</div>
